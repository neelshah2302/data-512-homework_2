...
# Licence: 
1.  https://www.mediawiki.org/wiki/API:REST_API#Terms_and_conditions
2.  https://creativecommons.org/licenses/by/4.0/

# REST API Documentation and other sources: 
1. https://www.mediawiki.org/wiki/API:Info
2. https://www.mediawiki.org/wiki/ORES
3. https://www.census.gov/data/tables/time-series/demo/popest/2020s-state-total.html
4. https://en.wikipedia.org/wiki/Category:Lists_of_cities_in_the_United_States_by_state
...
- The data may provide valuable insights into lesser-known or marginalized states but may not accurately represent well-known states. The data can definitely be quality-checked as well other datasets can be used to compare the results. As a source, the data is well structured and has matches for almost 85-90%  of the articles and thus can be used for data science research problems  for specific data analysis, Quantitative analysis, or as a starting point for understanding the information available on Wikipedia.
